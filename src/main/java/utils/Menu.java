...
public class Menu {
    ...
    public void displayInfoProcessingMenu(){
        ...
        System.out.println("9. Album");
        System.out.println("10. Sponsor");
        System.out.println("11. Episode");
        System.out.println("12. Assign Song to Artist");
        System.out.println("13. Assign Artist to Album");
        System.out.println("14. Assign Song to Record Label");
        System.out.println("15. Assign Artist to Record Label");
        System.out.println("16. Assign Song to Album");
