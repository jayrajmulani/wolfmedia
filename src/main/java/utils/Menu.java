...
public class Menu {
    ...
    public void displayMetaDataAndRecordsMenu(){
        ...
        System.out.println("-------------------------");
        System.out.println("1. Increase Song Playcounts");
        System.out.println("2. Decrease Song Playcounts");
        System.out.println("3. Find playcount for a Song");
        System.out.println("4. Increase Podcast Playcounts");
        System.out.println("5. Decrease Podcast Playcounts");
        System.out.println("6. Find playcount for a Podcast");
